...
# Portions copied/adapted from GVHMR hmr4d/utils/body_model/smplx_lite.py.
# Runtime paths are rewritten to be self-contained in the SplineHMR repository.
REPO_ROOT = Path(__file__).resolve().parents[3]
BODY_MODEL_ROOT = REPO_ROOT / "assets" / "body_models"
BODY_MODEL_UTILS_ROOT = Path(__file__).resolve().parent
...
class SmplxLiteCoco17(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load(BODY_MODEL_UTILS_ROOT / "smplx2smpl_sparse.pt")
        COCO17_regressor = torch.load(BODY_MODEL_UTILS_ROOT / "smpl_coco17_J_regressor.pt")
...
class SmplxLiteV437Coco17(SmplxLite):
    def __init__(self, **kwargs):
        ...
        # Verts437
        smplx_vids2 = torch.load(BODY_MODEL_UTILS_ROOT / "smplx_verts437.pt")
...
class SmplxLiteSmplN24(SmplxLite):
    ...
    def __init__(self, **kwargs):
        ...
        # Compute mapping
        smplx2smpl = torch.load(BODY_MODEL_UTILS_ROOT / "smplx2smpl_sparse.pt")
        smpl2joints = torch.load(BODY_MODEL_UTILS_ROOT / "smpl_neutral_J_regressor.pt")
